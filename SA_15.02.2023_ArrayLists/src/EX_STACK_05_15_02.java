...
class StudentStackEX051502{
    private String names;
    private int age;
    private double grade;
    private String gender;

    public StudentStackEX051502(String name, int age, double grade, String gender) {
        this.names = name;
        this.age = age;
        this.grade = grade;
        this.gender = gender;
...
public class EX_STACK_05_15_02 {
    public static void main(String[] args) {
        ...
        ArrayDeque<StudentStackEX051502> studentStack = new ArrayDeque<>();
        for (int i = 0; i < numberOfStudents; i++) {
            ...
            studentStack.push(new StudentStackEX051502(names, age, grade, gender));
        ...
        */
        ...
        for (StudentStackEX051502 student : studentStack) {
